  ...
  return (
    <div className="w-screen aspect-video pt-[20%] px-12 absolute text-white bg-gradient-to-r from-black">
      ...
      <div className="flex">
        ...
        <button className="flex items-center gap-2 cursor-pointer mx-2 bg-gray-500/50 text-white p-3 px-8 text-xl rounded-lg hover:bg-opacity-80 transition hover:opacity-80">
          <AiOutlineInfoCircle />
          More Info
        </button>
      </div>
